...
/***/ function(module, exports, __webpack_require__) {
	...
	Schema.render = function (schema, root) {
	...
	Schema.Controller = function (controller) {

		(0, _controller.setController)(controller);
	};

	Schema.Model = function (schemaModel) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var load = exports.load = function load(initTree, root) {
	  tree = initTree;
	  rootNode = createElement(tree);
	  root.appendChild(rootNode);
	};

	var update = exports.update = function update(newTree) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var compile = exports.compile = function compile(schema) {
		...
		if (!component.compiled) {
			...
			component.emit = function (label, data) {
				if (!data) data = [];
				if (typeof data == 'string') data = (0, _utils.getDataFromVar)(data, component.data);else if (Array.isArray) data = data.map(function (d) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var virtualElement = __webpack_require__(30);
	...
	var render = exports.render = function render(arr, data, component) {
	  ...
	  content = arr.map(function (slot) {
	    ...
	    // i.e { href: 'www.google.com' }
	        ...
	        var key = getObjectKey(slot);
	        var value = (0, _utils.getDataFromVar)(slot[key], data);
	        ...
	        if (value[0] == '>') {
	          ...
	          if (isArray(method)) value = function value() {
	        ...
	        // if a paramater is supplied the '>' token is not needed
	            ...
	            value = component[method].bind(undefined, component, args);
	          }
	  ...
	  if (isString(lastSlot)) content.push((0, _utils.getDataFromVar)(lastSlot, data));
...
/***/ function(module, exports) {
	...
	var getDataFromVar = exports.getDataFromVar = function getDataFromVar(v, data) {
...
/***/ function(module, exports) {
	...
	var setController = exports.setController = function setController(controller) {

		if (!Controller) Controller = controller;else for (var method in controller) {
			Controller[method] = controller[method];
		}if (controller.INIT) controller.INIT();
	};

	var useController = exports.useController = function useController(label, data) {
